...
//*/
		...
		input>>dummy>>xstore[polcount]>>ystore[polcount]>>zstore[polcount]>>vx[polcount]>>vy[polcount]>>vz[polcount]>>theta[polcount]>>phi[polcount]>>bounce[polcount];
...
//		fitG->SetParName(3,"Background");
		...
		gr0->SetTitle("Single Channel Linear Profile");
