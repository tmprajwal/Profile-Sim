...
//*/		
		input>>xstore[polcount]>>ystore[polcount]>>zstore[polcount],vx[polcount],vy[polcount],vz[polcount];
		vR[polcount]=sqrt(vx[polcount]*vx[polcount]+vy[polcount]*vy[polcount]);
		theta[polcount]=atan2(vR[polcount],vz[polcount]);
